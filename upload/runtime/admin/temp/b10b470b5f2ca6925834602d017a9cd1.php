<?php /*a:2:{s:69:"D:\phpstudy\WWW\video\video_my\upload\app\admin\view\member\edit.html";i:1678950848;s:74:"D:\phpstudy\WWW\video\video_my\upload\app\admin\view\common\container.html";i:1677049147;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="layui-row">
        <form class="layui-form" id="form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea type="text" name="description" value="<?php echo htmlentities($data['description']); ?>"  autocomplete="off" class="layui-input">
                    </textarea>>
                        </div>
            </div>
