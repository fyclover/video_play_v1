<?php /*a:1:{s:72:"D:\phpstudy\WWW\video\video_my\upload\app\admin\view\auth_group\add.html";i:1620709124;}*/ ?>
<!DOCTYPE html>
<html class="x-admin-sm">
  
  <head>
    <meta charset="UTF-8">
    <title>欢迎页面-新增角色</title>
                                    ...
                                    <td>
                                        <div class="layui-input-block">
                                            <?php if(is_array($v['rule']) || $v['rule'] instanceof \think\Collection || $v['rule'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['rule'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                <input name="rules[]" lay-skin="primary" type="checkbox" title="<?php echo htmlentities($vo['title']); ?>" value="<?php echo htmlentities($vo['id']); ?>"> 
