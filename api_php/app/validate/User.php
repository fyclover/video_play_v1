...
//        'admin.require' => '业务员ID必须是整数',
     ...
     */
    protected $scene = [
        'edit' => ['admin','user_name','agent_rate', 'pwd', 'withdraw_pwd', 'nickname', 'type', 'status','is_real_name','is_fictitious','id','invitation_code'],
        'add' => ['admin','user_name','agent_rate', 'pwd', 'withdraw_pwd', 'nickname', 'type', 'status','is_real_name','is_fictitious','invitation_code'],
        'detail' => ['id'],
        'status'=> ['id','status'],
